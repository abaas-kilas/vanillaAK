...
resource "google_container_cluster" "primary" {
  name               = "nodejs-vanillaak"  # cluster name
  ...
  provisioner "local-exec" {
    ...
    # green-post-341804 | us-central1-c | nodejs-vanillaak
    command = "gcloud container clusters get-credentials nodejs-vanillaak --zone us-central1-c --project green-post-341804"
  }
  node_config {
    preemptible  = true
